...
const AdminNotification = () => {
  ...
  return (
    <View style={styles.adminNotification}>
      <View
      ...
      <LinearGradient
        style={[styles.adminNotificationInner, styles.frameParentPosition]}
        locations={[0, 0.38]}
          ...
          <View style={styles.headlineParent}>
            ...
            <Text style={[styles.body, styles.mt12, styles.bodyTypo]}>
              <Text style={styles.bodyTxt}>
                <Text style={styles.youHaveNotifications}>
