...
const UserReportOffence = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.userReportOffence}>
      <View
      ...
      <View style={[styles.frameParent, styles.frameParentShadowBox]}>
        <View style={styles.frameGroup}>
          ...
          <Image
            style={[styles.vectorIcon, styles.mt127]}
            resizeMode="cover"
      ...
      >
        <Text style={[styles.copy, styles.copyTypo]}>Report Offense</Text>
      </View>
    </View>
  );
};
...
export default UserReportOffence;
