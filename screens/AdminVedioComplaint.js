...
const AdminVedioComplaint = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.adminVedioComplaint}>
      <View
      ...
      <LinearGradient
        style={[styles.adminVedioComplaintInner, styles.frameParentPosition]}
        locations={[0, 0.37]}
          ...
          <View style={styles.headlineParent}>
            ...
            <Text style={[styles.body, styles.mt12, styles.bodyTypo]}>
              <Text style={styles.bodyTxt}>
                <Text style={styles.youHaveNo}>You have no video</Text>
...
export default AdminVedioComplaint;
