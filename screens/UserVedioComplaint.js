...
const UserVedioComplaint = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.userVedioComplaint}>
      <View
      ...
      <View style={[styles.frameParent, styles.frameParentShadowBox]}>
          ...
          <View style={styles.headlineWrapper}>
            <Text style={[styles.headline, styles.copyTypo]}>
              <Text style={styles.headlineTxt}>
                <Text style={styles.recordAVoice}>
        ...
        >
          <Text style={[styles.copy, styles.copyTypo]}>
            <Text style={styles.recordAVoice}>Report Vedio</Text>
...
export default UserVedioComplaint;
