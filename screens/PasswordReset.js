...
const PasswordReset = () => {
  ...
  return (
    <View style={styles.passwordReset}>
      ...
      >
        <Text style={[styles.copy, styles.copyTypo]}>Reset Password</Text>
      </Pressable>
      <View style={[styles.passwordFormField, styles.passwordShadowBox]}>
        <Text style={[styles.anja, styles.anjaFlexBox]}>
      ...
      <View style={[styles.passwordFormField1, styles.passwordShadowBox]}>
        <Text style={[styles.anja, styles.anjaFlexBox]}>New Password</Text>
        <Image
          style={styles.teenyIconEyeClosed}
          resizeMode="cover"
          source={require("../assets/teeny-icon--eyeclosed2.png")}
      ...
      <View style={[styles.passwordFormField2, styles.passwordShadowBox]}>
      ...
      <Text style={[styles.resetPassword, styles.copyTypo]}>
        Reset Password
      </Text>
    </View>
  );
