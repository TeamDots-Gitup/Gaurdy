...
const AdminVoiceComplaint = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.adminVoiceComplaint}>
      <View
      ...
      <LinearGradient
        style={[styles.adminVoiceComplaintInner, styles.frameParentPosition]}
        locations={[0, 0.37]}
          ...
          <View style={styles.headlineParent}>
            ...
            <Text style={[styles.body, styles.mt12, styles.bodyTypo]}>
              <Text style={styles.bodyTxt}>
                <Text style={styles.youHaveNo}>You have no Voice</Text>
...
export default AdminVoiceComplaint;
